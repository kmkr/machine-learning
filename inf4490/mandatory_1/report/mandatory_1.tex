...
The difference from the Baldwinian model compared to the Lamarckian is that improvements from the hill climber are only used to prioritize the population, and \textit{discard the changes}. The results below shows the best of the 20 executions for the three different population sizes.
