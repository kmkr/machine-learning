...
\subsection*{The Lamarckian learning model}
...
Execute the \texttt{tsp\_genetic\_lamarckian.py} file with the amount of cities to check.

\begin{verbatim}
$ python tsp_genetic_lamarckian.py 24
\end{verbatim}


\subsection*{The Baldwinian learning model}
...
Execute the \texttt{tsp\_genetic\_baldwinian.py} file with the amount of cities to check.
